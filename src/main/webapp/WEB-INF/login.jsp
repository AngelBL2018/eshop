        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-1">
                <div class="login-form"><!--login form-->
                    ...
                    <spring:form action="#" method="post" modelAttribute="newUser">
                        <spring:label path="email">Email</spring:label>
                        <spring:input path="email" type="email"/>
                        <spring:label path="password">Password</spring:label>
                        <spring:input path="password" type="password" />
                        <span>
								<input type="checkbox" name="keepMeSignIN" class="checkbox">
								Keep me signed in
							</span>
            ...
            <div class="col-sm-4">
                <div class="signup-form"><!--sign up form-->
                    ...
                    <spring:form action="/signUp" method="post" modelAttribute="newUser" >
